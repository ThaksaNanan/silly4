						...
						<form action="#" id="reservation" method="post"
							...
							<section id="seats">
								...
								<label for="B2" class="seat"></label> <input id="B3" name="seat"
									class="seat-select" type="checkbox" value="B3" name="seat" />
								<label for="B3" class="seat"></label> <input id="B4" name="seat"
								...
								<label for="D2" class="seat"></label> <input id="D3" name="seat"
									class="seat-select" type="checkbox" value="D3" name="seat" />
								<label for="D3" class="seat"></label> <input id="D4" name="seat"
...
<%
	...
	String sql = "INSERT INTO booking (bk_No,Member_Cost,bk_Movie,bk_Seat) VALUES (null,'2390','" + name
			+ "','D5') ";
	s.execute(sql);
%>
</html>
