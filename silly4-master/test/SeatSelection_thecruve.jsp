...
"><span>check</span>
  ...
  <div class="page-select-seat">
    <div class="section-select-seat">
      <div class="container">
        <div class="row">
          <div class="col-sm-9" style="background-color: rgba(190, 188, 188, 0.438);
  border-radius: 5px;
  text-align: center;
  margin-left: 150px;">
            <form action="#" id="reservation" method="post"  class="reservation">
              <section id="seats">
                <input  id="A1"  name="seat" class="seat-select" type="checkbox"value="A1" name="seat"/>
                <label for="A1" class="seat"></label>
                <input  id="A2" name="seat" class="seat-select" type="checkbox" value="A2" name="seat" />
                <label for="A2" class="seat"></label>
                <input   id="A3" name="seat" class="seat-select" type="checkbox"value="A3" name="seat"/>
                <label for="A3" class="seat"></label>
                <input  id="A4" name="seat" class="seat-select" type="checkbox" value="A4" name="seat" />
                <label for="A4" class="seat"></label>
                <input  id="A5" name="seat" class="seat-select" type="checkbox" value="A5" name="seat" />
                <label for="A5" class="seat"></label>
                <br>
                <input  id="B1"  name="seat" class="seat-select" type="checkbox"value="B1" name="seat"/>
                <label for="B1" class="seat"></label>
                <input  id="B2" name="seat" class="seat-select" type="checkbox" value="B2" name="seat" />
                <label for="B2" class="seat"></label>
                <input  id="B3" name="seat" class="seat-select" type="checkbox"value="B3" name="seat"/>
                <label for="B3" class="seat"></label>
                <input  id="B4" name="seat" class="seat-select" type="checkbox" value="B4" name="seat" />
                <label for="B4" class="seat"></label>
                <input  id="B5" name="seat" class="seat-select" type="checkbox" value="B5" name="seat" />
                <label for="B5" class="seat"></label>
                <br>
                <input  id="C1"  name="seat" class="seat-select" type="checkbox"value="C1" name="seat"/>
                <label for="C1" class="seat"></label>
                <input  id="C2" name="seat" class="seat-select" type="checkbox" value="C2" name="seat" />
                <label for="C2" class="seat"></label>
                <input  id="C3" name="seat" class="seat-select" type="checkbox"value="C3" name="seat"/>
                <label for="C3" class="seat"></label>
                <input  id="C4" name="seat" class="seat-select" type="checkbox" value="C4" name="seat" />
                <label for="C4" class="seat"></label>
                <input  id="C5" name="seat" class="seat-select" type="checkbox" value="C5" name="seat" />
                <label for="C5" class="seat"></label>
                <br>
                <input  id="D1"  name="seat" class="seat-select" type="checkbox"value="D1" name="seat"/>
                <label for="D1" class="seat"></label>
                <input  id="D2" name="seat" class="seat-select" type="checkbox" value="D2" name="seat" />
                <label for="D2" class="seat"></label>
                <input  id="D3" name="seat" class="seat-select" type="checkbox"value="D3" name="seat"/>
                <label for="D3" class="seat"></label>
                <input  id="D4" name="seat" class="seat-select" type="checkbox" value="D4" name="seat" />
                <label for="D4" class="seat"></label>
                <input  id="D5" name="seat" class="seat-select" type="checkbox" value="D5" name="seat" />
                <label for="D5" class="seat"></label>
                <br>
              </section>
              <button type="button"id="button" name="getVal">Get Value of Selected</button>
            </form>
          </div>
          <div class="col-sm-3">
            <div class="sidebar-select-seat" style="width: 290px">
              <div class="member"><img src="Movie/YingA.jpg" style = "width :70%; hieght :70%; "></div>
                ...
                <div class="inner">
                  ...
                  <div class="action">
                    <div class="col"><button type="button"
                        ...
                        <!----></button></div>
                        <form method="get">
                    <div class="col"><button type="submit" disabled="disabled"
                        class="button button-blue button-continue btn-block"name="buy">
                        buy</button></div>
                        </form>
                  </div>
                </div>
  ...
  <!--
  <div id="messagePanel" class="messagePanel" onload="printarray" ></div>
  -->
