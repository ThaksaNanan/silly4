                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <div class="detail-box clearfix">
                                <div class="poster">
                                    <img src="Movie/Endgame.jpg">
                                </div>
                                <div class="movie-detail">
                                    <div class="main-detail">
                                        <h1 class="name">อเวนเจอร์ส: เผด็จศึก</h1>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10 border-section">
                                    <div class="right-section">
                                        ...
                                        <ul class="time-list">
                                        <form action="SeatSelection_Avenger.php" method="post">
                        <input type="hidden" value = "The Avenger End Game" name="name_movie">
